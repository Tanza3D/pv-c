...
public:
    ...
    static std::vector<std::vector<TZColor>> preprocessGradient(const std::vector<std::vector<TZColor>> &gradientMap, int width = 65, int height = 33);

    static std::vector<std::vector<TZColor>> easyGradient(const std::string &topLeftHex,
